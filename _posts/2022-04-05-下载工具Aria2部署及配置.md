...
# 从会话文件中读取下载任务
input-file=/home/arch/.aria2/aria2.session

# 会话文件保存路径
# Aria2 退出时或指定的时间间隔会保存`错误/未完成`的下载任务到会话文件
save-session=/home/arch/.aria2/aria2.session
...
dht-file-path=/home/arch/.aria2/dht.dat

# IPv6 DHT 文件路径，默认：$HOME/.aria2/dht6.dat
dht-file-path6=/home/arch/.aria2/dht6.dat
